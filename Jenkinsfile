    ...
    stages {
        ...
        stage('Deploy to test-Server') {
            steps {
                ...
                ansiblePlaybook become: true, credentialsId: 'ansibleadmin', disableHostKeyChecking: true, extras: 'user: \'ansible\'', installation: 'ansible', inventory: '/etc/ansible/hosts', playbook: 'ansible-playbook.yml', vaultTmpPath: ''            
            } 
        }
